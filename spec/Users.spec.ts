...
import { User, UserImplement } from '@entities/UserImplement';
...
describe('UserRouter', () => {
    ...
    describe(`"GET:${getUsersPath}"`, () => {
        ...
        it(`should return a JSON object with all the users and a status code of "${OK}" if the
            ...
            // Setup Dummy Data
            const users = [
                new UserImplement('Sean Maxwell', 'sean.maxwell@gmail.com'),
                new UserImplement('John Smith', 'john.smith@gmail.com'),
                new UserImplement('Gordan Freeman', 'gordan.freeman@gmail.com'),
            ];
    ...
    describe(`"POST:${addUsersPath}"`, () => {
        ...
        const userData = {
            user: new UserImplement('Gordan Freeman', 'gordan.freeman@gmail.com'),
        };
